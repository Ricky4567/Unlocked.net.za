...
<template>
  <div class="scroll-container">
    <v-row>
      <h3 class="white--text my-3" style="margin-left:100px;">ACTION MOVIES</h3>
    </v-row>
              ...
              >
                ...
                <div class="overlay-content-bottom">
                  <div class="overlay-text-bottom">
                    ...
                    <div class="text-details mx-2">{{ movie.release_date | formatDate }}</div>
                    <div class="text-caption mx-2">{{ truncatedText(movie.overview, 120) }}</div>
                  </div>
                </div>
              </v-img>
            </v-card>
